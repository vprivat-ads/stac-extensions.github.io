...
| [Camera](https://github.com/linz/stac/tree/master/extensions/camera)* | *Unknown* | *Unknown* | *Unknown* | *Unknown* | *Unknown* | Camera related metadata, such as focal length and sequence number. Especially useful for aerial imagery surveys. |
...
| [accuracy](https://github.com/stac-extensions/accuracy) | *Unknown* | *Unknown* | *Unknown* | 1.0.0-beta.1 | 2023-12-18 | Fields to provide estimates of accuracy, both geometric and measurement (e.g., radiometric) accuracy. |
...
| [attribution](https://github.com/stac-extensions/attribution) | *Unknown* | *Unknown* | *Unknown* | 0.1.0 | 2024-08-01 | Allows to provide an attribution, e.g. for maps, compliant with OGC API Collections |
| [contacts](https://github.com/stac-extensions/contacts) | *Unknown* | *Unknown* | *Unknown* | 0.1.1 | 2023-05-17 | A list of contacts with detailed information such as address, phone numbers, emails etc. |
| [datacube](https://github.com/stac-extensions/datacube) | *Unknown* | *Unknown* | *Unknown* | 2.2.0 | 2023-05-03 | Datacube related metadata to describe their dimensions and variables. |
...
| [goes](https://github.com/stac-extensions/goes) | *Unknown* | *Unknown* | *Unknown* | 1.0.0 | 2022-09-22 | STAC Extension for NOAA GOES (Geostationary Operational Environmental Satellite) products |
...
| [render](https://github.com/stac-extensions/render) | *Unknown* | *Unknown* | *Unknown* | 2.0.0 | 2024-11-19 | Provide consumers with the information required to view an asset properly (e.g. on a online map) |
| [scientific](https://github.com/stac-extensions/scientific) | *Unknown* | *Unknown* | *Unknown* | 1.0.0 | 2021-07-26 | Metadata that indicate from which publication data originates and how the data itself should be cited or referenced. |
| [sentinel-2](https://github.com/stac-extensions/sentinel-2) | *Unknown* | *Unknown* | *Unknown* | 1.0.0 | 2023-11-13 | Sentinel-2 STAC Extension |
| [sentinel-5p](https://github.com/stac-extensions/sentinel-5p) | *Unknown* | *Unknown* | *Unknown* | 0.2.0 | 2024-06-10 | Sentinel-5P STAC Extension  |
| [ssys](https://github.com/stac-extensions/ssys) | *Unknown* | *Unknown* | *Unknown* | 1.1.0 | 2023-10-19 | SSYS STAC Extension Specification |
| [stats](https://github.com/stac-extensions/stats) | *Unknown* | *Unknown* | *Unknown* | 0.2.0 | 2022-08-01 | Describes the number of items, extensions and assets that are contained in a STAC catalog. |
| [stereo-imagery](https://github.com/stac-extensions/stereo-imagery) | *Unknown* | *Unknown* | *Unknown* | 1.0.0 | 2023-08-02 | Describes (tri-)stereo imagery that consists of multiple captures, often for 3D use cases. |
...
| [trainingdml-ai-extension](https://github.com/openrsgis/trainingdml-ai-extension)* | *Unknown* | *Unknown* | *Unknown* | 1.0.0 | 2023-05-24 | Detailed metadata for formalizing the information model of geospatial EO machine learning training data.  |
| [usfws-nwi](https://github.com/stac-extensions/usfws-nwi) | *Unknown* | *Unknown* | *Unknown* | 1.0.0 | 2022-10-24 | Describes the U.S. Fish & Wildlife Service (FWS) National Wetlands Inventory (NWI) products |
| [view](https://github.com/stac-extensions/view) | *Unknown* | *Unknown* | *Unknown* | 1.0.0 | 2021-03-30 | View Geometry adds metadata related to angles of sensors and other radiance angles that affect the view of resulting data. |
...
* **Last updated:** May 17 2025, 01:21 UTC
* **Count:** 80
...
* [hsi](https://github.com/stac-extensions/hsi)
