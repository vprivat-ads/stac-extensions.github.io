...
| [Electro-Optical](https://github.com/stac-extensions/eo) | eo | Collection, Item | Stable | 2.0.0-beta.1 | Covers electro-optical data that represents a snapshot of the Earth. It could consist of cloud cover and multiple spectral bands, for example visible bands, infrared bands, red edge bands and panchromatic bands. |
...
| [Raster](https://github.com/stac-extensions/raster) | raster | Collection, Item | Candidate | 2.0.0-beta.1 | Describes raster assets at band level (one or multiple) with specific information such as data type, unit, number of bits used, nodata. |
...
* **Last updated:** Sep 07 2024, 01:06 
* **Count:** 76
